...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Mania', "Changes the song keycount mid-chart.\nValue 1: New keycount (examples: 4, 6, 9k)\nValue 2: Optional fallback keycount field.\nIf Value 1 is blank, Value 2 will be used.\n (PSYCH ONLINE ONLY)"],
